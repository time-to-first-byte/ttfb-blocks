...
export default registerBlockType(
    'ttfb-blocks/test',
    {
        title: __( 'Test Fields', 'ttfb-blocks' ),
        description: __( 'An example of how to use form fields in the Inspector element.', 'ttfb-blocks'),
        category: 'common',
        icon,
        keywords: [
            __( 'Palette', 'ttfb-blocks' ),
            __( 'Settings', 'ttfb-blocks' ),
            __( 'Scheme', 'ttfb-blocks' ),
        ],
        attributes,
